...
var Config_SecurityConfig = /* @__PURE__ */ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "admin_key", kind: "scalar", T: 12, repeated: true },
    {
      no: 4,
      name: "is_managed",
      kind: "scalar",
...
var Config_SessionkeyConfig = /* @__PURE__ */ proto3.makeMessageType(
...
var DeviceMetrics = /* @__PURE__ */ proto3.makeMessageType(
  ...
  () => [
    { no: 1, name: "battery_level", kind: "scalar", T: 13, opt: true },
    { no: 2, name: "voltage", kind: "scalar", T: 2, opt: true },
    { no: 3, name: "channel_utilization", kind: "scalar", T: 2, opt: true },
    { no: 4, name: "air_util_tx", kind: "scalar", T: 2, opt: true },
    { no: 5, name: "uptime_seconds", kind: "scalar", T: 13, opt: true }
  ]
);
var EnvironmentMetrics = /* @__PURE__ */ proto3.makeMessageType(
  "meshtastic.EnvironmentMetrics",
  () => [
    { no: 1, name: "temperature", kind: "scalar", T: 2, opt: true },
    { no: 2, name: "relative_humidity", kind: "scalar", T: 2, opt: true },
    { no: 3, name: "barometric_pressure", kind: "scalar", T: 2, opt: true },
    { no: 4, name: "gas_resistance", kind: "scalar", T: 2, opt: true },
    { no: 5, name: "voltage", kind: "scalar", T: 2, opt: true },
    { no: 6, name: "current", kind: "scalar", T: 2, opt: true },
    { no: 7, name: "iaq", kind: "scalar", T: 13, opt: true },
    { no: 8, name: "distance", kind: "scalar", T: 2, opt: true },
    { no: 9, name: "lux", kind: "scalar", T: 2, opt: true },
    { no: 10, name: "white_lux", kind: "scalar", T: 2, opt: true },
    { no: 11, name: "ir_lux", kind: "scalar", T: 2, opt: true },
    { no: 12, name: "uv_lux", kind: "scalar", T: 2, opt: true },
    { no: 13, name: "wind_direction", kind: "scalar", T: 13, opt: true },
    { no: 14, name: "wind_speed", kind: "scalar", T: 2, opt: true },
    { no: 15, name: "weight", kind: "scalar", T: 2, opt: true },
    { no: 16, name: "wind_gust", kind: "scalar", T: 2, opt: true },
    { no: 17, name: "wind_lull", kind: "scalar", T: 2, opt: true }
  ]
);
var PowerMetrics = /* @__PURE__ */ proto3.makeMessageType(
  "meshtastic.PowerMetrics",
  () => [
    { no: 1, name: "ch1_voltage", kind: "scalar", T: 2, opt: true },
    { no: 2, name: "ch1_current", kind: "scalar", T: 2, opt: true },
    { no: 3, name: "ch2_voltage", kind: "scalar", T: 2, opt: true },
    { no: 4, name: "ch2_current", kind: "scalar", T: 2, opt: true },
    { no: 5, name: "ch3_voltage", kind: "scalar", T: 2, opt: true },
    { no: 6, name: "ch3_current", kind: "scalar", T: 2, opt: true }
  ]
);
var AirQualityMetrics = /* @__PURE__ */ proto3.makeMessageType(
  "meshtastic.AirQualityMetrics",
  () => [
    { no: 1, name: "pm10_standard", kind: "scalar", T: 13, opt: true },
    { no: 2, name: "pm25_standard", kind: "scalar", T: 13, opt: true },
    { no: 3, name: "pm100_standard", kind: "scalar", T: 13, opt: true },
    { no: 4, name: "pm10_environmental", kind: "scalar", T: 13, opt: true },
    { no: 5, name: "pm25_environmental", kind: "scalar", T: 13, opt: true },
    { no: 6, name: "pm100_environmental", kind: "scalar", T: 13, opt: true },
    { no: 7, name: "particles_03um", kind: "scalar", T: 13, opt: true },
    { no: 8, name: "particles_05um", kind: "scalar", T: 13, opt: true },
    { no: 9, name: "particles_10um", kind: "scalar", T: 13, opt: true },
    { no: 10, name: "particles_25um", kind: "scalar", T: 13, opt: true },
    { no: 11, name: "particles_50um", kind: "scalar", T: 13, opt: true },
    { no: 12, name: "particles_100um", kind: "scalar", T: 13, opt: true }
  ]
);
var LocalStats = /* @__PURE__ */ proto3.makeMessageType(
...
var Position = /* @__PURE__ */ proto3.makeMessageType(
  "meshtastic.Position",
  () => [
    { no: 1, name: "latitude_i", kind: "scalar", T: 15, opt: true },
    { no: 2, name: "longitude_i", kind: "scalar", T: 15, opt: true },
    { no: 3, name: "altitude", kind: "scalar", T: 5, opt: true },
    {
      no: 4,
      name: "time",
      kind: "scalar",
    ...
    { no: 9, name: "altitude_hae", kind: "scalar", T: 17, opt: true },
    { no: 10, name: "altitude_geoidal_separation", kind: "scalar", T: 17, opt: true },
    {
      no: 11,
      name: "PDOP",
      kind: "scalar",
    ...
    { no: 15, name: "ground_speed", kind: "scalar", T: 13, opt: true },
    { no: 16, name: "ground_track", kind: "scalar", T: 13, opt: true },
    {
      no: 17,
      name: "fix_quality",
      kind: "scalar",
...
var RouteDiscovery = /* @__PURE__ */ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "snr_towards", kind: "scalar", T: 5, repeated: true },
    { no: 3, name: "route_back", kind: "scalar", T: 7, repeated: true },
    { no: 4, name: "snr_back", kind: "scalar", T: 5, repeated: true }
  ]
);
...
var Data = /* @__PURE__ */ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 9, name: "bitfield", kind: "scalar", T: 13, opt: true }
  ]
);
var Waypoint = /* @__PURE__ */ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "latitude_i", kind: "scalar", T: 15, opt: true },
    { no: 3, name: "longitude_i", kind: "scalar", T: 15, opt: true },
    {
      no: 4,
      name: "expire",
      kind: "scalar",
...
var ClientNotification = /* @__PURE__ */ proto3.makeMessageType(
  "meshtastic.ClientNotification",
  () => [
    { no: 1, name: "reply_id", kind: "scalar", T: 13, opt: true },
    {
      no: 2,
      name: "time",
      kind: "scalar",
...
var AdminMessage = /* @__PURE__ */ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 23, name: "set_scale", kind: "scalar", T: 13, oneof: "payload_variant" },
    ...
    { no: 43, name: "set_time_only", kind: "scalar", T: 7, oneof: "payload_variant" },
    ...
    { no: 94, name: "factory_reset_device", kind: "scalar", T: 5, oneof: "payload_variant" },
    ...
    { no: 99, name: "factory_reset_config", kind: "scalar", T: 5, oneof: "payload_variant" },
...
var UserLite = /* @__PURE__ */ proto3.makeMessageType(
  "meshtastic.UserLite",
  () => [
    {
      no: 1,
...
__export(utils_exports, {
  ...
  Queue: () => Queue,
  Xmodem: () => Xmodem,
  nodeTransformHandler: () => nodeTransformHandler,
...
var transformHandler = (logger, onReleaseEvent, onDeviceDebugLog, concurrentLogOutput) => {
...
var nodeTransformHandler = (logger, onReleaseEvent, onDeviceDebugLog, concurrentLogOutput) => {
  let byteBuffer = new Uint8Array([]);
  const log = logger.getSubLogger({ name: "streamTransfer" });
  return new Transform({
    transform(chunk, _encoding, controller) {
      onReleaseEvent.subscribe(() => {
        controller();
      });
      byteBuffer = new Uint8Array([...byteBuffer, ...chunk]);
...
var NodeSerialConnection = class extends MeshDevice {
  /** Defines the connection type as serial */
  connType;
  portId;
  /** Serial port used to communicate with device. */
   ...
   */
  async readFromRadio(concurrentLogOutput) {
    ...
    transformedStream?.on("data", (data) => {
  ...
  async writeToRadio(data) {
    ...
    await write(new Uint8Array([148, 195, 0, data.length, ...data])).catch(
      (err) => {
        console.log(err);
      }
    );
