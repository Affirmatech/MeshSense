...
import * as SerialPort$1 from 'serialport';
...
type ConnectionParameters = HttpConnectionParameters | BleConnectionParameters | SerialConnectionParameters | NodeSerialConnectionParameters;
...
interface NodeSerialConnectionParameters {
    baudRate?: number;
    portPath: string;
    concurrentLogOutput: boolean;
}
...
type ConnectionType = BleConnection | HttpConnection | SerialConnection | NodeSerialConnection;
...
type types_NodeSerialConnectionParameters = NodeSerialConnectionParameters;
...
declare const transformHandler: (logger: Logger<unknown>, onReleaseEvent: SimpleEventDispatcher<boolean>, onDeviceDebugLog: SimpleEventDispatcher<Uint8Array>, concurrentLogOutput: boolean) => TransformStream<Uint8Array, Uint8Array>;
...
declare const nodeTransformHandler: (logger: Logger<unknown>, onReleaseEvent: SimpleEventDispatcher<boolean>, onDeviceDebugLog: SimpleEventDispatcher<Uint8Array>, concurrentLogOutput: boolean) => Transform;
...
declare const index_nodeTransformHandler: typeof nodeTransformHandler;
...
declare namespace index {
  export { index_EventSystem as EventSystem, index_Queue as Queue, index_Xmodem as Xmodem, index_nodeTransformHandler as nodeTransformHandler, index_transformHandler as transformHandler, index_typedArrayToBuffer as typedArrayToBuffer };
}
...
declare class NodeSerialConnection extends MeshDevice {
    /** Defines the connection type as serial */
    connType: ConnectionTypeName;
    protected portId: string;
    /** Serial port used to communicate with device. */
    port: SerialPort$1.SerialPort | undefined;
     ...
     */
    connect({ portPath, baudRate, concurrentLogOutput, }: NodeSerialConnectionParameters): Promise<void>;
    /** Disconnects from the serial port */
    reconnect(): Promise<void>;
    /** Disconnects from the serial port */
    disconnect(): Promise<SerialPort$1.SerialPort | undefined>;
    /** Pings device to check if it is avaliable */
    ping(): Promise<boolean>;
    /**
     * Sends supplied protobuf message to the radio
...
export { BleConnection, Client, Constants, FromNumUuid, FromRadioUuid, HttpConnection, MeshDevice, NodeSerialConnection, protobufs as Protobuf, SerialConnection, ServiceUuid, ToRadioUuid, types as Types, index as Utils, broadcastNum, minFwVer };
